                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <select name="role_level" id="role_level" required
                                    ...
                                    <option value="2" {{ old('role_level') == '2' ? 'selected' : '' }}>Level 2 - Staff (Bulanan)</option>
                                    <option value="3" {{ old('role_level') == '3' ? 'selected' : '' }}>Level 3 - Worker (Mingguan)</option>
                                </select>
                            </div>
        ...
        function updatePositions() {
            ...
            if (levelPositions[level]) {
                levelPositions[level].forEach(pos => {
                    ...
                    if ('{{ old("position") }}' === pos) option.selected = true;
